...
###############################################################################
    if ML_model_option_lower in MatterSim:
        ...
        Compiled_Model_Path = f"{models_dir}/MatterSim/{MatterSim[ML_model_option_lower]}"
        ASE_Calculator = MatterSimCalculator(load_path=Compiled_Model_Path,device=kwargs['device'])
###############################################################################
#          Meta Ai (Facebook)
###############################################################################
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        predictor = pretrained_mlip.get_predict_unit(Meta_UMA[ML_model_option_lower], device=kwargs['device'])
